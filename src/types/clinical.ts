...
// In: — | Out: ToothStatus, ToothFinding, ToothSurface, ToothRecord, PlanStatus, ProcedureStatus, TreatmentPlan, Procedure, ClinicalNote, AttachmentType, Attachment | See: F031, F032, F160, F209
...
export type ToothSurface = 'M' | 'D' | 'O' | 'B' | 'L' | 'C'
